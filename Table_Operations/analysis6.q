// read the data
t: ("DSTFF";enlist ",") 0: hsym `$getenv[`AX_WORKSPACE],"/Data/trade.csv";
q: ("DSTFFFF";enlist ",") 0: hsym `$getenv[`AX_WORKSPACE],"/Data/quote.csv";
p: ("DSSSITTFF";enlist ",") 0: hsym `$getenv[`AX_WORKSPACE],"/Data/parent_order.csv";
c:("SSDSTFF";enlist ",") 0: hsym `$getenv[`AX_WORKSPACE],"/Data/child_order.csv";
